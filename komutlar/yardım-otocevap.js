...
.setColor('#ffd100') 
.setAuthor(`HamHell Oto Cevap Komutları`, client.user.avatarURL())
.setDescription(`<a:pirate:749380925619437619> HamHell botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
