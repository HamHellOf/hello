...
.setColor('#ffd100') 
.setAuthor(`HamHell Moderasyon Komutları`, client.user.avatarURL())
.setDescription(`<a:hypesquad1:750076071721828452> HamHell botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
